...
namespace Tests
{
    public class NotaFiscalTests
    {
        ...
        [Test]
        public void DeveGerarNFComValorDeImpostoDescontadoPara1000()
        {
            ...
            Assert.AreEqual(1000 * 0.98, nf.Valor);
        }

        [Test]
        public void DeveGerarNFComValorDeImpostoDescontadoPara2500()
        {
            GeradorDeNotaFiscal gerador = new GeradorDeNotaFiscal(new List<IAcaoAposGerarNota>());
            ...
            Assert.AreEqual(2500 * 0.94, nf.Valor);
        }
